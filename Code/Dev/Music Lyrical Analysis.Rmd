...
Our dataset is almost ready for exploration. There's a few remaining data wrangling steps to complete:
  ...
  2. We have the option to remove stop words at this point, although I would like to leave them in for initial exploration and remove them when we begin more detailed text analysis.
...
Is it safe to say that this collection of songs is an example of an eclectic collection? Perhaps. Although, reality suggests that humans can find a way of proving and dis-proving similarity using a variety of configurable techniques.
